...
def init_model(opt):
    ...
    if opt.pretrain_model:
        logging.info("loading previous checkpoint from %s" % opt.pretrain_model)
...
def main(opt):
    ...
    if opt.weighting_reassign:
        train_ml_wr.train_model(model, optimizer, train_data_loader, valid_data_loader, opt)
    else:
