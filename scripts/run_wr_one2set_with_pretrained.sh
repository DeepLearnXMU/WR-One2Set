...
model_name="WR_One2set"
data_args="Full"
main_args="WR_One2Set_${seed}"
...
pretrain_exp="../pretrained/One2Set_based_model.pt"
...
do
  echo "============================= testing ${data} ================================="
  test_out_dir="output/test/${exp}_score/${data}"
